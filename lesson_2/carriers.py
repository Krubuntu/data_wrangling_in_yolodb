...
def extract_carriers(page):
    ...
    with open(page, "r") as html:
        ...
        for airline in carrier.find_all('option'):
            airline_value = airline.get("value")
            if not re.match(ALL_PATTERN, airline_value):
                print(airline.get("value"))
                data.append((airline_value))
